        ...
        <div className="max-w-screen-lg p-4 flex flex-col justify-center  w-full">
          <div name="about" className="w-full flex text-white  lg:mt-4 mt-8 ">
            <div className="  p-4 flex flex-col justify-center items-center w-full">
              <div className="pb-8">
                <p className="text-4xl font-bold inline border-b-4 font-[spaceB] border-[#0FB807]">
                  About Me
                </p>
              </div>

              <div className="p-6 sm:p-12  dark:text-gray-100">
                ...
                <div className="flex justify-center pt-4 space-x-4 align-center">
                  <a
                    ...
                    href="#"
                    aria-label="GitHub"
                    className="p-2 rounded-md dark:text-gray-100 hover:dark:text-green-400"
                  >
                    <svg
                      viewBox="0 0 496 512"
